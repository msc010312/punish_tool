...
| 문서 | [발표자료(브라우저)](프로젝트_발표자료.html), [시연 시나리오](제출물/시연_시나리오.md), [소스/링크 정리](제출물/GitHub_링크정리.md) |

## 문서 (과제 산출물)

- 📘 [프로젝트 설명서](제출물/프로젝트_설명서.md) — 모듈·데이터·실행법 상세
- 📊 [프로젝트 발표자료](프로젝트_발표자료.html) — 18슬라이드 덱, 브라우저로 열기 (음성 포함본은 제출물 폴더)
- 🎭 [페르소나 카드](제출물/페르소나_카드.md) — 솔 배드가이 코치 정의
- 📈 [평가 리포트](제출물/평가_리포트.md) — RAGAS 정렬 실측 (Faithfulness 1.00)
- 💰 [호출 로그 요약](제출물/호출_로그_요약.md) — 엔진·비용($0)·TTFB
- 🎬 [시연 시나리오](제출물/시연_시나리오.md) — 데모 영상 스토리보드(≤10분)
- 🪞 [회고서](제출물/회고서.md) · [자기평가서](제출물/자기평가서.md)
