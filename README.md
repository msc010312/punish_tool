...
| 트랙 | 이 프로젝트의 결과물 |
|---|---|
| 기획 | 페르소나(솔 배드가이)·도메인 카드(GGST), [프로젝트 설명서](제출물/프로젝트_설명서.md) |
...
| 문서 | [최종 보고서](제출물/프로젝트_최종보고서_공개용.html), [시연 시나리오](제출물/시연_시나리오.md), [소스/링크 정리](제출물/GitHub_링크정리.md) |

## 문서

- 📘 [프로젝트 설명서](제출물/프로젝트_설명서.md) — 모듈·데이터·실행법 상세
- 📊 [프로젝트 최종 보고서](제출물/프로젝트_최종보고서_공개용.html) — 발표용 (브라우저로 열기)
- 🎬 [시연 시나리오](제출물/시연_시나리오.md) — 데모 영상 스토리보드
- 🔗 [GitHub 링크·샘플소스 정리](제출물/GitHub_링크정리.md)
